...
/** Decorative bits — matches `AgentOnboardingScreenFive`. */
const CONFETTI = [
...
export type PersonalOnboardingScreenEightProps = {
  onStartExploring: () => void;
};

/** Congratulations — layout mirrors `AgentOnboardingScreenFive`; copy for roommate onboarding. */
export function PersonalOnboardingScreenEight({
  onStartExploring,
}: PersonalOnboardingScreenEightProps) {
        ...
        >
          <View style={styles.heroStage}>
            ...
            <Text style={styles.lede}>
              Your roommate profile is ready—time to explore.
            </Text>
          ...
          <View style={[styles.card, { maxWidth: contentMaxW }]}>
            <View style={styles.cardAccent} />
            <Text style={styles.cardBody}>Thank you for joining Ellieo.</Text>
            <Text style={styles.cardBody}>
              Browse listings, save favorites, and connect with roommates when
              you&apos;re ready—we&apos;re glad you&apos;re here.
            </Text>
